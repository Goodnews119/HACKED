...
def HACKED(series):
    ...
    with ThreadPoolExecutor(max_workers=30) as Fuck_xnxx:
        ...
        for love in gen:
            ids = SEX + love
            passlist = ["123456", "1234567", "12345678", "123456789"," 000000","1234567890","123123","khan123","singh123","salamkhan"]
...
def HACKING():
    ...
    clear()
    ____banner____()
    os.system("xdg-open https://www.facebook.com/John.Jackson0087")
